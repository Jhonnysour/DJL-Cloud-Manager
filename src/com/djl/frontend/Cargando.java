...
public class Cargando extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El archivo que seleccionó ya se encuentra en la nube");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel3.setText("Desea reemplazarlo?");
        ...
        setAlwaysOnTop(true);
        setResizable(false);
        setSize(new java.awt.Dimension(824, 626));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pngapp/loading-2.gif"))); // NOI18N
